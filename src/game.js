(() => {
  ...
  const LEVELS = [
    {
      ...
      platforms: [
        [60,520,500,44,'cloud'], [650,455,320,42,'cloud'], [1080,545,350,44,'cloud'], [1500,420,300,42,'spring'],
        [1900,520,360,44,'cloud'], [2380,390,300,42,'spring'], [2780,500,430,44,'cloud']
      ],
    ...
    },
    {
      ...
      platforms: [
        [40,510,420,44,'cloud'], [560,420,260,42,'spring'], [940,530,260,44,'cloud'], [1300,380,250,42,'cloud'],
        [1650,520,300,44,'spring'], [2060,390,260,42,'cloud'], [2430,555,290,44,'cloud'], [2830,390,260,42,'spring'],
        [3200,520,300,44,'cloud'], [3590,360,460,44,'cloud']
      ],
    ...
    },
    {
      ...
      platforms: [
        [20,520,420,44,'cloud'], [560,450,250,40,'spring'], [930,350,230,40,'cloud'], [1270,520,250,42,'spring'],
        [1650,400,260,40,'cloud'], [2040,560,250,42,'cloud'], [2420,400,240,40,'spring'], [2790,285,220,40,'cloud'],
        [3150,480,260,42,'cloud'], [3520,340,240,40,'spring'], [3890,530,260,42,'cloud'], [4260,360,250,40,'spring'], [4660,480,430,44,'cloud']
      ],
  ...
  function update(dt) {
    ...
    if (inputPressed('jump')) player.jumpBuffer = .14;
    ...
    if (!inputDown('jump') && player.vy < -150) player.vy += 900 * dt;
    ...
    for (const gem of level.prisms) {
      ...
      if (dx*dx + dy*dy < (player.r+gem.r+10)**2) {
        gem.got = true;
        state.prism++;
